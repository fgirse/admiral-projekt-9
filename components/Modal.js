            ...
            <div className="border-5 border-gray-100 relative w-auto my-6 mx-auto max-w-lg">
              ...
              <div className="w-full rounded-lg shadow-lg relative flex flex-col bg-gray-800 outline-none focus:outline-none">
                ...
                <div className="relative w-11/12 p-6 flex-auto">
                  ...
                  <iframe width="400" height="280" frameborder="5" scrolling="no" marginheight="0" marginwidth="0" src="https://www.openstreetmap.org/export/embed.html?bbox=7.846389412879945%2C47.991591082233796%2C7.8532880544662484%2C47.99406817889533&amp;layer=cyclemap&amp;marker=47.992829645428266%2C7.849838733673096" style={{border: "1px solid orange"}}/>
                  </div>
                </div>
                {/*footer*/}
                <div className="flex items-center justify-end p-6 border-t border-solid border-blueGray-200 rounded-b">
                  <button
                    className="w-48 bg-gray-800 text-gray-100 rounded-2xl border-2 border-gray-100 font-bold hover:text-yellow-400 hover:bg-gray-700 font-bold uppercase px-6 py-2 text-sm outline-none focus:outline-none mr-1 mb-1 ease-linear transition-all duration-150"
                    type="button"
                    onClick={() => setShowModal(false)}
                  >
                    Close
