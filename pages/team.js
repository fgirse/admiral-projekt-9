        ...
        <Heading1>DAS TEAM</Heading1>
            <div className="-mt-20 flex flex-wrap -mx-8">
              <div className="md:w-1/3 xl:p-36">
                ...
                <p className="mt-4  text-1xl text-gray-300 leading-relaxed xl:text-2xl                                                                                                                                                                                                                                                                                                                                                                                                              ld">Simon ist Teammitglied der ersten Stunde. Im richtigen Leben studiert Simon an der Uni Erziehungswissenschaften und hat gerade seinee Master absolviert. Simon ist ausgewiesener SC Freiburg Fan und wann immer möglich begleited er das Team zu den Auswärtsspielen</p>
              </div> 
